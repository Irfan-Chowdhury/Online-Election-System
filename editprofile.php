...
<?php
    ...
    {
        $updatetUser  = $reg->userUpdate($_POST, $_FILES, $voterId); //--> watch class/Registration.php, method-10
	}
?>
    <div class="container pl-5">   
        <h3>User Profile Update</h3>
<?php
	if (isset($updatetUser)) {  //show Message
		echo $updatetUser;
	}
?>
...
<?php
    ...
    $getProfile=$reg->getUserProfile($voterId); //Watch class/Registration.php, Method-8
    if ($getProfile) {
